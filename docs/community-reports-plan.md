...
2. **Medium term** — replace personal WhatsApp with a project email (e.g., `contato.soroja@gmail.com`) that forwards wherever the maintainer wants. Decoupled from any individual phone.
...
7. Does the footer contact migrate to `contato.soroja@gmail.com` in the Phase 1 PR or later?
