# Refresh diff — CE — 2026-07-26

- **Candidato:** `extracted/CE.candidate.json`
- **Atual:** `extracted/CE.json`
- **Linhas atuais:** 49
- **Linhas no candidato:** 49
- **CNES adicionados:** 0
- **CNES removidos:** 0
- **CNES alterados:** 0
...
3. Substituir: `cp extracted/CE.candidate.json extracted/CE.json`
