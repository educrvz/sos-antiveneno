# Refresh diff — PA — 2026-07-26

- **Candidato:** `extracted/PA.candidate.json`
- **Atual:** `extracted/PA.json`
- **Linhas atuais:** 168
- **Linhas no candidato:** 168
- **CNES adicionados:** 0
- **CNES removidos:** 0
- **CNES alterados:** 0
...
3. Substituir: `cp extracted/PA.candidate.json extracted/PA.json`
