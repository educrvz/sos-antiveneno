...
|--------|------:|--:|-------------|
| `auto_accept` | 1,446 | 63.6% | `build/geocode_auto_accept_v3.csv` |
| `watchlist` | 29 | 1.3% | `build/geocode_watchlist_v3.csv` |
| `retry_queue` | 785 | 34.5% | `build/geocode_retry_queue_v3.csv` |
...
|--------|-----:|-----:|-----:|-----:|
| `auto_accept` | 0 | 0 | 0 | 1446 |
| `watchlist` | 0 | 29 | 0 | 0 |
| `retry_queue` | 165 | 453 | 107 | 60 |
