# Refresh diff — MT — 2026-07-26

- **Candidato:** `extracted/MT.candidate.json`
- **Atual:** `extracted/MT.json`
- **Linhas atuais:** 103
- **Linhas no candidato:** 103
- **CNES adicionados:** 0
- **CNES removidos:** 0
- **CNES alterados:** 0
...
3. Substituir: `cp extracted/MT.candidate.json extracted/MT.json`
