# Refresh diff — AP — 2026-07-26

- **Candidato:** `extracted/AP.candidate.json`
- **Atual:** `extracted/AP.json`
- **Linhas atuais:** 25
- **Linhas no candidato:** 25
- **CNES adicionados:** 0
- **CNES removidos:** 0
- **CNES alterados:** 0
...
3. Substituir: `cp extracted/AP.candidate.json extracted/AP.json`
