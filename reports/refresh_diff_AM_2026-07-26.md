# Refresh diff — AM — 2026-07-26

- **Candidato:** `extracted/AM.candidate.json`
- **Atual:** `extracted/AM.json`
- **Linhas atuais:** 91
- **Linhas no candidato:** 91
- **CNES adicionados:** 0
- **CNES removidos:** 0
- **CNES alterados:** 0
...
3. Substituir: `cp extracted/AM.candidate.json extracted/AM.json`
