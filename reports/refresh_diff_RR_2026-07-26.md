# Refresh diff — RR — 2026-07-26

- **Candidato:** `extracted/RR.candidate.json`
- **Atual:** `extracted/RR.json`
- **Linhas atuais:** 33
- **Linhas no candidato:** 33
- **CNES adicionados:** 0
- **CNES removidos:** 0
- **CNES alterados:** 0
...
3. Substituir: `cp extracted/RR.candidate.json extracted/RR.json`
