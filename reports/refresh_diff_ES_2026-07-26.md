# Refresh diff — ES — 2026-07-26

- **Candidato:** `extracted/ES.candidate.json`
- **Atual:** `extracted/ES.json`
- **Linhas atuais:** 61
- **Linhas no candidato:** 61
- **CNES adicionados:** 0
- **CNES removidos:** 0
- **CNES alterados:** 0
...
3. Substituir: `cp extracted/ES.candidate.json extracted/ES.json`
